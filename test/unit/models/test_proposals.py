...
def test_proposal_is_valid(proposal):
    ...
    # this is actually the CryptoDex foundation multisig address...
    ...
    # ============================================================
    # ensure proposal can't request negative cryptodex 
    # ============================================================
